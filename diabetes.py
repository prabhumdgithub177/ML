...
models.append(('KNN', KNeighborsClassifier(n_neighbors = 5, metric = 'minkowski', p = 2,algorithm='auto')))
models.append(('CART', DecisionTreeClassifier(criterion = 'gini', splitter='best',min_samples_split=2,random_state=5,max_depth=None,)))
models.append(('NB', GaussianNB(var_smoothing=1e-9)))
#models.append(('SVM', SVC(kernel = 'linear', random_state = 0)))
#models.append(('SVM', SVC(kernel = 'poly', degree=3, gamma=2, coef0=1)))
models.append(('Random',RandomForestClassifier(n_estimators = 42, random_state = 5,min_samples_split=2)))
